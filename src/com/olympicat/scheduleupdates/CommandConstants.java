...
public interface CommandConstants {
    ...
    final byte ADD_CANCEL_DUMMY = 0x63; // Syntax: {HEADER} {FLAG} {CLASS_ID} {HOUR} {DATE} {TEACHER_NAME} ;; HOUR is max 2 bytes (3 - 4), DATE is always 8 bytes (5 - 12), TEACHER_NAME has unknown amount of bytes (12 - ?)
